package com.jackyfan.handsonagentscope.agentscopejava.rag;

import com.jackyfan.handsonagentscope.agentscopejava.util.ExampleUtils;
...
public class ImageRag {
    ...
    private static void addImageDocuments(Knowledge knowledge) throws IOException {
        // Sample documents about AgentScope
        String imagePath = "src/main/resources/image.png";
        ImageReader reader = new ImageReader(false);
        ReaderInput input = ReaderInput.fromFile(imagePath);
